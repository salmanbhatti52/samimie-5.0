...
class MyTheme {
  ...
  static const Color accent_color = Color.fromRGBO(0, 0, 0, 1);
  ...
  static Color splash_screen_color = Color.fromRGBO(
      0, 0, 0, 0); // if not sure , use the same color as accent color
  ...
  static Color golden = Color.fromRGBO(255, 168, 0, .4);
  static Color amber = Color.fromRGBO(254, 234, 209, 1);
  static Color amber_medium = Color.fromRGBO(254, 240, 215, 1);
  static Color golden_shadow = Color.fromRGBO(153, 153, 153, .4);
